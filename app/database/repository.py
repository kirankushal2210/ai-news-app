...
class Repository:
    ...
    def get_articles_without_digest(self, limit: Optional[int] = None) -> List[Dict[str, Any]]:
        ...
        # Include YouTube videos regardless of transcript status (use description as fallback)
        ...
        for video in youtube_videos:
            ...
            if key not in seen_ids:
                articles.append({
                    ...
                    "title": video.title,
                    "url": video.url,
                    "content": video.transcript or video.description or "No content available",
        ...
        for article in anthropic_articles:
            ...
            if key not in seen_ids:
                articles.append({
                    ...
                    "title": article.title,
                    "url": article.url,
                    "content": article.markdown or article.description or "No content available",
                    "published_at": article.published_at
                })
